  ...
  <body>
    ...
    <div class="card text-left">
        ...
        <div class="card-header">
            ...
            <ul class="nav nav-pills card-header-pills">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="viewreferred" >View Referred List </a>
                </li>
                <!-- <li class="nav-item">
    ...
    <div style="padding-top: 20px; padding-left: 30px; padding-right: 720px; ">
        ...
        <form action="temp.php" method="POST">
            ...
            <button type="submit" class="btn btn-primary" name="createEntryOfPending" id="createEntryOfPending">Submit</button>
